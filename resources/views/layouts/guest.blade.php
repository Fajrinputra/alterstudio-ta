...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gradient-to-br from-[#F8F1E7] to-[#f0e4d5] text-[#5b422b] antialiased min-h-screen overflow-hidden" 
        ...
        <div class="min-h-screen flex items-center justify-center p-0 relative">
            <div class="w-full">
                {{ $slot }}
            </div>
        </div>
